...
|---|---|---|
| ADR | `0070`–`0079` | `0070` (staff identity, authorisation enforcement and audit anchoring) |
...
| `tools/src/fraudshield_tools/licences.py` | two version-pinned `EXCEPTIONS` for Jakarta Mail and Angus Mail | owner-approved; CI's licence job fails without them (ADR 0020) |
