...
| FR-01-02 | M | M6 | NOT_STARTED | Transaction schema: transaction_id (UUID), account_id (tokenised), counterparty_id (tokenised), amount (DECIMAL 18,4), currency (ISO 4217 3-char), channel ENUM(MOBILE_MONEY/CARD/AGENT_BANKING/USSD/ONLINE/BANK_TRANSFER), merchant_category_code (4-char), latitude, longitude, device_fingerprint (nullable), transaction_timestamp (ISO 8601 UTC) | — | backend/persistence/src/test/java/io/github/mariusbayizere/fraudshield/persistence/SchemaPoliciesTest.java:144<br>contracts/tests/test_events.py:365<br>contracts/tests/test_openapi.py:110<br>contracts/tests/test_validation_vectors.py:137<br>contracts/tests/test_validation_vectors.py:39<br>contracts/tests/test_validation_vectors.py:78<br>dataset/tests/test_generator.py:162 | — | — |
...
| NFR-SEC-03 | M | M7 | IN_PROGRESS | PII tokenisation | contracts/openapi/fraudshield-api.yaml<br>backend/persistence/src/main/resources/db/migration/V3__transactions_and_scoring.sql | backend/persistence/src/test/java/io/github/mariusbayizere/fraudshield/persistence/SchemaPoliciesTest.java:143<br>contracts/tests/test_events.py:190<br>contracts/tests/test_events.py:221<br>contracts/tests/test_events.py:292<br>contracts/tests/test_events.py:365<br>contracts/tests/test_openapi.py:453<br>contracts/tests/test_validation_vectors.py:39 | — | docs/adr/0021-m1-scope-replan.md |
...
| D-08 | M | M2 | DONE | Results on synthetic data can look perfect and prove nothing. | dataset/src/fraudshield_dataset/realism/checks.py<br>dataset/src/fraudshield_dataset/realism/stats.py | dataset/tests/test_generator.py:118<br>dataset/tests/test_generator.py:132<br>dataset/tests/test_generator.py:162<br>dataset/tests/test_generator.py:330<br>dataset/tests/test_generator.py:354<br>dataset/tests/test_generator.py:515<br>dataset/tests/test_generator.py:543<br>dataset/tests/test_generator.py:638<br>dataset/tests/test_keys.py:10<br>dataset/tests/test_keys.py:10<br>dataset/tests/test_keys.py:10<br>dataset/tests/test_keys.py:10<br>dataset/tests/test_params.py:14<br>dataset/tests/test_params.py:14<br>dataset/tests/test_params.py:14<br>dataset/tests/test_params.py:14<br>dataset/tests/test_params.py:14<br>dataset/tests/test_params.py:14<br>dataset/tests/test_params.py:14<br>dataset/tests/test_params.py:14<br>dataset/tests/test_params.py:14<br>dataset/tests/test_params.py:26<br>dataset/tests/test_params.py:61<br>dataset/tests/test_realism_checks.py:29<br>dataset/tests/test_realism_checks.py:29<br>dataset/tests/test_realism_checks.py:29<br>dataset/tests/test_realism_checks.py:29<br>dataset/tests/test_realism_checks.py:29<br>dataset/tests/test_realism_checks.py:29<br>dataset/tests/test_realism_checks.py:29<br>dataset/tests/test_realism_checks.py:29<br>dataset/tests/test_realism_checks.py:29<br>dataset/tests/test_realism_checks.py:29<br>dataset/tests/test_realism_checks.py:29<br>dataset/tests/test_realism_checks.py:29<br>dataset/tests/test_realism_checks.py:29<br>dataset/tests/test_realism_checks.py:29<br>dataset/tests/test_realism_checks.py:29<br>dataset/tests/test_realism_checks.py:29<br>dataset/tests/test_realism_checks.py:29<br>dataset/tests/test_realism_checks.py:29<br>dataset/tests/test_realism_checks.py:29<br>dataset/tests/test_realism_checks.py:29<br>dataset/tests/test_realism_checks.py:29<br>dataset/tests/test_realism_checks.py:29<br>dataset/tests/test_realism_checks.py:490<br>dataset/tests/test_realism_checks.py:81<br>dataset/tests/test_shortcut_diagnosis.py:14<br>dataset/tests/test_shortcut_diagnosis.py:14<br>dataset/tests/test_shortcut_diagnosis.py:14<br>dataset/tests/test_shortcut_diagnosis.py:14<br>dataset/tests/test_shortcut_diagnosis.py:14<br>dataset/tests/test_shortcut_diagnosis.py:14<br>dataset/tests/test_shortcut_diagnosis.py:14<br>dataset/tests/test_shortcut_diagnosis.py:14<br>dataset/tests/test_stats.py:104<br>dataset/tests/test_stats.py:18<br>dataset/tests/test_stats.py:18<br>dataset/tests/test_stats.py:18<br>dataset/tests/test_stats.py:18<br>dataset/tests/test_stats.py:18<br>dataset/tests/test_stats.py:18<br>dataset/tests/test_stats.py:18<br>dataset/tests/test_stats.py:18<br>dataset/tests/test_stats.py:18 | dataset/tests/test_realism_checks.py (eleven planted leaks, each caught by the gate it targets)<br>dataset/realism_report.md (single-feature AUCs, shortcut and event detectors, label noise, novelty placement) | — |
...
| D-20 | M | M6 | NOT_STARTED | "PostgreSQL TDE" does not exist in community PostgreSQL 16. | — | — | — | docs/adr/0021-m1-scope-replan.md |
...
| D-30 | M | M1 | DONE | auto_block_events is declared immutable but contains mutable columns | backend/persistence/src/main/resources/db/migration/V5__blocking_verification_and_labels.sql<br>backend/persistence/src/main/resources/db/migration/V4__alerts_rules_and_campaigns.sql<br>backend/persistence/src/main/resources/db/migration/V1__tenancy_and_common_functions.sql<br>docs/adr/0017-data-model-and-database-security.md | backend/persistence/src/test/java/io/github/mariusbayizere/fraudshield/persistence/DatabaseSecurityTest.java:25<br>backend/persistence/src/test/java/io/github/mariusbayizere/fraudshield/persistence/SchemaPoliciesTest.java:167 | backend/persistence/src/test/java/io/github/mariusbayizere/fraudshield/persistence/DatabaseSecurityTest.java (append-only tables deny UPDATE and DELETE to every application role)<br>backend/persistence/src/test/java/io/github/mariusbayizere/fraudshield/persistence/SchemaPoliciesTest.java (autoBlockStateIsDerivedFromAppendOnlyFacts: v_auto_block_status from blocked to frozen; other tenant sees nothing)<br>docs/reviews/M1/milestone-review.md (M1 milestone review and delta re-check) | — |
