...
| D-14 | M | M6 | NOT_STARTED | MEDIUM "hold for 30 seconds" cannot be an open HTTP request. | — | contracts/tests/test_compatibility.py:40<br>contracts/tests/test_events.py:148<br>contracts/tests/test_events.py:341<br>contracts/tests/test_openapi.py:161<br>contracts/tests/test_openapi.py:173<br>contracts/tests/test_openapi.py:209<br>contracts/tests/test_openapi.py:360<br>contracts/tests/test_webhooks.py:27<br>contracts/tests/test_webhooks.py:75<br>contracts/tests/test_webhooks.py:86 | — | — |
