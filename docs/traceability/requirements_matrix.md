...
| ML-DATA-01 | M | M2 | VERIFIED_AT_REDUCED_SCALE | Total size | dataset/src/fraudshield_dataset/generator/pipeline.py<br>dataset/src/fraudshield_dataset/generator/config.py | dataset/tests/test_generator.py:109<br>dataset/tests/test_generator.py:430<br>dataset/tests/test_generator.py:52<br>dataset/tests/test_realism_checks.py:425<br>dataset/tests/test_sensitivity.py:67 | dataset/realism_report.md (1,006,212-row verification run; the size gate needs 5M and is PB-25)<br>dataset/tests/test_generator.py (byte-identical output across chunk sizes, including across a Parquet row-group boundary)<br>docs/backlog/product.md (PB-25 records the release-size run as an M2 gate item) | D-07 |
| ML-DATA-02 | M | M2 | DONE | Fraud rate | dataset/generator/params/fraud.yaml<br>dataset/src/fraudshield_dataset/generator/fraud.py | dataset/tests/test_generator.py:363<br>dataset/tests/test_generator.py:373<br>dataset/tests/test_generator.py:382<br>dataset/tests/test_generator.py:389<br>dataset/tests/test_realism_checks.py:425 | dataset/realism_report.md (0.870% overall, 0.915% test, all 24 monthly intervals covering target)<br>dataset/tests/test_realism_checks.py (the fraud-rate gate reacts when fraud is removed) | — |
| ML-DATA-03 | M | M2 | DONE | Channel distribution | dataset/src/fraudshield_dataset/generator/config.py<br>dataset/generator/params/channels.yaml | dataset/tests/test_generator.py:109<br>dataset/tests/test_realism_checks.py:425 | dataset/realism_report.md (channel mix within 0.17 pp)<br>dataset/tests/test_generator.py (iterative proportional fitting reproduces the SRS mix exactly) | — |
| ML-DATA-04 | M | M2 | DONE | Fraud pattern diversity | dataset/src/fraudshield_dataset/generator/fraud.py<br>docs/ml/scenarios/README.md | dataset/tests/test_generator.py:250<br>dataset/tests/test_generator.py:389<br>dataset/tests/test_realism_checks.py:460<br>dataset/tests/test_realism_checks.py:71<br>dataset/tests/test_scenario_notes.py:11<br>dataset/tests/test_scenario_notes.py:11 | dataset/realism_report.md (eight scenario types present, per-scenario rows by month)<br>dataset/tests/test_scenario_notes.py (every scenario has a design note citing existing parameters) | D-08 |
| ML-DATA-05 | M | M2 | DONE | Geographic coverage | dataset/src/fraudshield_dataset/generator/population.py<br>dataset/generator/params/geography.yaml | dataset/tests/test_generator.py:109<br>dataset/tests/test_generator.py:168<br>dataset/tests/test_generator.py:415<br>dataset/tests/test_normal.py:9<br>dataset/tests/test_normal.py:9<br>dataset/tests/test_normal.py:9<br>dataset/tests/test_realism_checks.py:425 | dataset/realism_report.md (country mix within 0.02 pp)<br>dataset/tests/test_generator.py (every population prefix within one customer of its country quota) | — |
| ML-DATA-06 | M | M2 | DONE | Temporal coverage | dataset/src/fraudshield_dataset/generator/config.py | dataset/tests/test_generator.py:69 | dataset/realism_report.md (24 months, 2024-01 to 2025-12, with the temporal split)<br>dataset/tests/test_generator.py (month labels cross the year boundary) | D-07 |
| ML-DATA-07 | M | M2 | NOT_STARTED | Feature completeness | — | — | — | D-04 |
| ML-DATA-08 | M | M2 | IN_PROGRESS | Dataset release | dataset/src/fraudshield_dataset/release/export.py<br>docs/ml/datasheet.md | dataset/tests/test_export.py:19<br>dataset/tests/test_export.py:19<br>dataset/tests/test_export.py:19<br>dataset/tests/test_export.py:19<br>dataset/tests/test_export.py:19<br>dataset/tests/test_export.py:19<br>dataset/tests/test_export.py:19<br>dataset/tests/test_realism_checks.py:314<br>dataset/tests/test_realism_checks.py:330<br>dataset/tests/test_realism_checks.py:371 | dataset/tests/test_export.py (CSV carries every row, checksums verify, a changed file is reported)<br>dataset/release/README.md (CC BY 4.0 legal code with its source URL and SHA-256) | — |
...
| RES-01 | M | M2 | NOT_STARTED | FraudShield-EAC-Transactions dataset | — | dataset/tests/test_generator.py:69 | — | D-08<br>D-09 |
...
| D-07 | M | M2 | DONE | Temporal split definitions disagree | dataset/src/fraudshield_dataset/generator/config.py<br>dataset/generator/params/split.yaml | dataset/tests/test_generator.py:363 | dataset/realism_report.md (train, validation, calibration, 7-day embargo and test, with measured rates)<br>dataset/tests/test_generator.py (the split plan's boundaries and the embargo width) | — |
| D-08 | M | M2 | DONE | Results on synthetic data can look perfect and prove nothing. | dataset/src/fraudshield_dataset/realism/checks.py<br>dataset/src/fraudshield_dataset/realism/stats.py | dataset/tests/test_generator.py:250<br>dataset/tests/test_generator.py:274<br>dataset/tests/test_generator.py:430<br>dataset/tests/test_generator.py:52<br>dataset/tests/test_generator.py:63<br>dataset/tests/test_generator.py:88<br>dataset/tests/test_keys.py:10<br>dataset/tests/test_keys.py:10<br>dataset/tests/test_keys.py:10<br>dataset/tests/test_keys.py:10<br>dataset/tests/test_params.py:14<br>dataset/tests/test_params.py:14<br>dataset/tests/test_params.py:14<br>dataset/tests/test_params.py:14<br>dataset/tests/test_params.py:14<br>dataset/tests/test_params.py:14<br>dataset/tests/test_params.py:14<br>dataset/tests/test_params.py:14<br>dataset/tests/test_params.py:14<br>dataset/tests/test_params.py:26<br>dataset/tests/test_params.py:61<br>dataset/tests/test_realism_checks.py:27<br>dataset/tests/test_realism_checks.py:27<br>dataset/tests/test_realism_checks.py:27<br>dataset/tests/test_realism_checks.py:27<br>dataset/tests/test_realism_checks.py:27<br>dataset/tests/test_realism_checks.py:27<br>dataset/tests/test_realism_checks.py:27<br>dataset/tests/test_realism_checks.py:27<br>dataset/tests/test_realism_checks.py:27<br>dataset/tests/test_realism_checks.py:27<br>dataset/tests/test_realism_checks.py:27<br>dataset/tests/test_realism_checks.py:27<br>dataset/tests/test_realism_checks.py:27<br>dataset/tests/test_realism_checks.py:27<br>dataset/tests/test_realism_checks.py:27<br>dataset/tests/test_realism_checks.py:27<br>dataset/tests/test_realism_checks.py:27<br>dataset/tests/test_realism_checks.py:27<br>dataset/tests/test_realism_checks.py:27<br>dataset/tests/test_realism_checks.py:27<br>dataset/tests/test_realism_checks.py:27<br>dataset/tests/test_realism_checks.py:71<br>dataset/tests/test_stats.py:104<br>dataset/tests/test_stats.py:18<br>dataset/tests/test_stats.py:18<br>dataset/tests/test_stats.py:18<br>dataset/tests/test_stats.py:18<br>dataset/tests/test_stats.py:18<br>dataset/tests/test_stats.py:18<br>dataset/tests/test_stats.py:18<br>dataset/tests/test_stats.py:18<br>dataset/tests/test_stats.py:18 | dataset/tests/test_realism_checks.py (eleven planted leaks, each caught by the gate it targets)<br>dataset/realism_report.md (single-feature AUCs, shortcut and event detectors, label noise, novelty placement) | — |
