...
| NFR-SEC-03 | M | M1 | NOT_STARTED | PII tokenisation | — | contracts/tests/test_events.py:190<br>contracts/tests/test_events.py:221<br>contracts/tests/test_events.py:292<br>contracts/tests/test_events.py:365<br>contracts/tests/test_openapi.py:452<br>contracts/tests/test_validation_vectors.py:39 | — | — |
...
| D-32 | M | M1 | NOT_STARTED | Audit log needs tamper evidence, not only permissions, and "12 action types" are unnamed. | — | contracts/tests/test_events.py:309<br>contracts/tests/test_openapi.py:422 | — | — |
