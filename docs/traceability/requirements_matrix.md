...
| NFR-SEC-03 | M | M1 | NOT_STARTED | PII tokenisation | — | contracts/tests/test_events.py:159<br>contracts/tests/test_events.py:190<br>contracts/tests/test_events.py:261<br>contracts/tests/test_events.py:334<br>contracts/tests/test_openapi.py:452<br>contracts/tests/test_validation_vectors.py:39 | — | — |
...
| D-14 | M | M6 | NOT_STARTED | MEDIUM "hold for 30 seconds" cannot be an open HTTP request. | — | contracts/tests/test_compatibility.py:38<br>contracts/tests/test_events.py:148<br>contracts/tests/test_events.py:341<br>contracts/tests/test_openapi.py:161<br>contracts/tests/test_openapi.py:173<br>contracts/tests/test_openapi.py:209<br>contracts/tests/test_openapi.py:360<br>contracts/tests/test_webhooks.py:27<br>contracts/tests/test_webhooks.py:75<br>contracts/tests/test_webhooks.py:86 | — | — |
...
| D-32 | M | M1 | NOT_STARTED | Audit log needs tamper evidence, not only permissions, and "12 action types" are unnamed. | — | contracts/tests/test_events.py:278<br>contracts/tests/test_openapi.py:422 | — | — |
...
| D-43 | M | M8 | IN_PROGRESS | SRS has no localisation, yet serves Rwanda and the EAC. | backend/common/src/main/java/io/github/mariusbayizere/fraudshield/common/money/Money.java<br>backend/common/src/main/java/io/github/mariusbayizere/fraudshield/common/money/CurrencyCode.java | backend/common/src/test/java/io/github/mariusbayizere/fraudshield/common/money/MoneyBoundaryTest.java:22<br>backend/common/src/test/java/io/github/mariusbayizere/fraudshield/common/money/MoneyTest.java:19<br>backend/common/src/test/java/io/github/mariusbayizere/fraudshield/common/money/MoneyTest.java:27<br>backend/common/src/test/java/io/github/mariusbayizere/fraudshield/common/money/MoneyTest.java:46<br>contracts/tests/test_events.py:309<br>contracts/tests/test_openapi.py:109<br>contracts/tests/test_openapi.py:127 | — | — |
