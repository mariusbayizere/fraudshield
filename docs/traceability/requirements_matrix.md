...
| ML-DATA-01 | M | M2 | NOT_STARTED | Total size | — | dataset/tests/test_generator.py:42<br>dataset/tests/test_generator.py:99 | — | D-07 |
| ML-DATA-02 | M | M2 | NOT_STARTED | Fraud rate | — | — | — | — |
| ML-DATA-03 | M | M2 | NOT_STARTED | Channel distribution | — | dataset/tests/test_generator.py:99 | — | — |
| ML-DATA-04 | M | M2 | NOT_STARTED | Fraud pattern diversity | — | — | — | D-08 |
| ML-DATA-05 | M | M2 | NOT_STARTED | Geographic coverage | — | dataset/tests/test_generator.py:99 | — | — |
| ML-DATA-06 | M | M2 | NOT_STARTED | Temporal coverage | — | dataset/tests/test_generator.py:59 | — | D-07 |
...
| RES-01 | M | M2 | NOT_STARTED | FraudShield-EAC-Transactions dataset | — | dataset/tests/test_generator.py:59 | — | D-08<br>D-09 |
...
| D-08 | M | M2 | NOT_STARTED | Results on synthetic data can look perfect and prove nothing. | — | dataset/tests/test_generator.py:42<br>dataset/tests/test_generator.py:53<br>dataset/tests/test_generator.py:78<br>dataset/tests/test_keys.py:10<br>dataset/tests/test_keys.py:10<br>dataset/tests/test_keys.py:10<br>dataset/tests/test_keys.py:10<br>dataset/tests/test_params.py:14<br>dataset/tests/test_params.py:14<br>dataset/tests/test_params.py:14<br>dataset/tests/test_params.py:14<br>dataset/tests/test_params.py:14<br>dataset/tests/test_params.py:14<br>dataset/tests/test_params.py:14 | — | — |
