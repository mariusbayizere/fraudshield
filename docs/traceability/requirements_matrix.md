...
Rows: 258. Status counts: DONE 5, DONE_WITH_DEVIATION 1, IN_PROGRESS 9, NOT_STARTED 243.
...
| ML-DATA-01 | M | M2 | NOT_STARTED | Total size | — | dataset/tests/test_generator.py:104<br>dataset/tests/test_generator.py:47 | — | D-07 |
| ML-DATA-02 | M | M2 | NOT_STARTED | Fraud rate | — | dataset/tests/test_generator.py:297<br>dataset/tests/test_generator.py:307<br>dataset/tests/test_generator.py:316<br>dataset/tests/test_generator.py:323 | — | — |
| ML-DATA-03 | M | M2 | NOT_STARTED | Channel distribution | — | dataset/tests/test_generator.py:104 | — | — |
| ML-DATA-04 | M | M2 | NOT_STARTED | Fraud pattern diversity | — | dataset/tests/test_generator.py:217<br>dataset/tests/test_generator.py:323<br>dataset/tests/test_realism_checks.py:63<br>dataset/tests/test_scenario_notes.py:11<br>dataset/tests/test_scenario_notes.py:11 | — | D-08 |
...
| RES-01 | M | M2 | NOT_STARTED | FraudShield-EAC-Transactions dataset | — | dataset/tests/test_generator.py:64 | — | D-08<br>D-09 |
...
| D-07 | M | M2 | NOT_STARTED | Temporal split definitions disagree | — | dataset/tests/test_generator.py:297 | — | — |
| D-08 | M | M2 | NOT_STARTED | Results on synthetic data can look perfect and prove nothing. | — | dataset/tests/test_generator.py:217<br>dataset/tests/test_generator.py:241<br>dataset/tests/test_generator.py:47<br>dataset/tests/test_generator.py:58<br>dataset/tests/test_generator.py:83<br>dataset/tests/test_keys.py:10<br>dataset/tests/test_keys.py:10<br>dataset/tests/test_keys.py:10<br>dataset/tests/test_keys.py:10<br>dataset/tests/test_params.py:14<br>dataset/tests/test_params.py:14<br>dataset/tests/test_params.py:14<br>dataset/tests/test_params.py:14<br>dataset/tests/test_params.py:14<br>dataset/tests/test_params.py:14<br>dataset/tests/test_params.py:14<br>dataset/tests/test_realism_checks.py:19<br>dataset/tests/test_realism_checks.py:19<br>dataset/tests/test_realism_checks.py:19<br>dataset/tests/test_realism_checks.py:19<br>dataset/tests/test_realism_checks.py:19<br>dataset/tests/test_realism_checks.py:19<br>dataset/tests/test_realism_checks.py:19<br>dataset/tests/test_realism_checks.py:19<br>dataset/tests/test_realism_checks.py:19<br>dataset/tests/test_realism_checks.py:63<br>dataset/tests/test_stats.py:8<br>dataset/tests/test_stats.py:8<br>dataset/tests/test_stats.py:8<br>dataset/tests/test_stats.py:8<br>dataset/tests/test_stats.py:8 | — | — |
...
| D-31 | M | M1 | DONE_WITH_DEVIATION | Tables required by functional requirements are missing from the schema. | backend/persistence/src/main/resources/db/migration/V2__identity_and_access.sql<br>backend/persistence/src/main/resources/db/migration/V3__transactions_and_scoring.sql<br>backend/persistence/src/main/resources/db/migration/V6__risk_configuration.sql<br>backend/persistence/src/main/resources/db/migration/V7__models_and_training.sql<br>backend/persistence/src/main/resources/db/migration/V9__outbox.sql<br>backend/persistence/src/main/resources/db/migration/V11__grants.sql | backend/persistence/src/test/java/io/github/mariusbayizere/fraudshield/persistence/DatabaseSecurityTest.java:26<br>tools/tests/test_migration_guard.py:11<br>tools/tests/test_migration_guard.py:11<br>tools/tests/test_migration_guard.py:11<br>tools/tests/test_migration_guard.py:11<br>tools/tests/test_migration_guard.py:11 | backend/persistence/src/test/java/io/github/mariusbayizere/fraudshield/persistence/DatabaseSecurityTest.java (tenant isolation, composite foreign keys, uniqueness rules)<br>tools/tests/test_migration_guard.py (merged migrations are immutable)<br>docs/reviews/M1/milestone-review.md (M1 milestone review and delta re-check) | docs/adr/0017-data-model-and-database-security.md |
