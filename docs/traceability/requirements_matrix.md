...
| ML-DATA-05 | M | M2 | NOT_STARTED | Geographic coverage | — | dataset/tests/test_generator.py:106<br>dataset/tests/test_generator.py:165<br>dataset/tests/test_generator.py:375<br>dataset/tests/test_normal.py:9<br>dataset/tests/test_normal.py:9<br>dataset/tests/test_normal.py:9 | — | — |
| ML-DATA-06 | M | M2 | NOT_STARTED | Temporal coverage | — | dataset/tests/test_generator.py:66 | — | D-07 |
...
| RES-01 | M | M2 | NOT_STARTED | FraudShield-EAC-Transactions dataset | — | dataset/tests/test_generator.py:66 | — | D-08<br>D-09 |
...
| D-07 | M | M2 | NOT_STARTED | Temporal split definitions disagree | — | dataset/tests/test_generator.py:327 | — | — |
| D-08 | M | M2 | NOT_STARTED | Results on synthetic data can look perfect and prove nothing. | — | dataset/tests/test_generator.py:247<br>dataset/tests/test_generator.py:271<br>dataset/tests/test_generator.py:49<br>dataset/tests/test_generator.py:60<br>dataset/tests/test_generator.py:85<br>dataset/tests/test_keys.py:10<br>dataset/tests/test_keys.py:10<br>dataset/tests/test_keys.py:10<br>dataset/tests/test_keys.py:10<br>dataset/tests/test_params.py:14<br>dataset/tests/test_params.py:14<br>dataset/tests/test_params.py:14<br>dataset/tests/test_params.py:14<br>dataset/tests/test_params.py:14<br>dataset/tests/test_params.py:14<br>dataset/tests/test_params.py:14<br>dataset/tests/test_realism_checks.py:19<br>dataset/tests/test_realism_checks.py:19<br>dataset/tests/test_realism_checks.py:19<br>dataset/tests/test_realism_checks.py:19<br>dataset/tests/test_realism_checks.py:19<br>dataset/tests/test_realism_checks.py:19<br>dataset/tests/test_realism_checks.py:19<br>dataset/tests/test_realism_checks.py:19<br>dataset/tests/test_realism_checks.py:19<br>dataset/tests/test_realism_checks.py:63<br>dataset/tests/test_stats.py:8<br>dataset/tests/test_stats.py:8<br>dataset/tests/test_stats.py:8<br>dataset/tests/test_stats.py:8<br>dataset/tests/test_stats.py:8 | — | — |
