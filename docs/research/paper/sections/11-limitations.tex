...
modelling choice that differs from the documented form of the scam, whose recipient is usually new
(Section~\ref{sec:generalisation}); the result bounds the harder case and says nothing about the
