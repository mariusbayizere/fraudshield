...
\begin{itemize}
  \item transactions per active customer, mobile money volume growth, per-channel mean amounts and
       ...
       , Annex H, Tables H1, H2, H3 and H5 (page 48) and H8 (page 49), and
        Annex I (page 50);
  ...
  \item active customers per agent and per merchant acceptance point: the National Bank of Rwanda's
        annual report, Table 11 (page 86) and the count of active mobile payment
        subscribers (page 87);
  \item the urban share of the population: Rwanda's 2022 census, Table 2
        (printed page 5, page 30 of the PDF), and mobile money use by urban and rural adults:
        FinScope Rwanda 2024, Figure 26 (page 40);
  \item exchange rates: the World Bank's official exchange rates; time zones: the
        IANA time zone database; currency codes and minor units: the ISO 4217
        list;
  \item the months in which school terms begin: one Rwandan school's 2024--2025 calendar
       ;
  \item regional-bloc membership: the East African Community and COMESA
        membership pages.
\end{itemize}
