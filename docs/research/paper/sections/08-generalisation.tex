...
draw \texttt{d8083dbc}, source \texttt{docs/benchmarks/m4\_battery\_d8083dbc\_e1.txt}). CD rests
...
\cite{TODO-verify} in which the victim, persuaded that money was ``sent by mistake'', makes a single
