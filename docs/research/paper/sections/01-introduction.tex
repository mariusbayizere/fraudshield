...
manipulation, mule accounts, social-engineering scams) is shaped by those channels. Systems
designed around card fraud in other markets assume device fingerprints, card-present signals and
merchant structures that many of these transactions do not have \cite{TODO-verify}. We do not
