...
\paragraph{Evidence.} Every figure in this paper comes from a raw output file under
...
tracking in MLflow was not used for the M4 evidence (ADR 0030); the evidence files carry the
provenance instead.
