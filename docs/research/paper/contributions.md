...
| **The M4 gate misses recall at the 0.60 flag threshold**: 0.736 [0.707, 0.765] against 0.88 (FNR 0.264), with the other nine M4 gate metrics passing. It is a ranking shortfall, not a threshold choice — recall is 0.871 even at the 1% FPR budget — and it is reported as measured, D-02's threshold unchanged and nothing tuned on the test period | ADR 0031, PB-62, `docs/benchmarks/m4_gate_d8083dbc_v3.txt` |
